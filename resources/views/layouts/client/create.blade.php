            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('client.store') }}" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('m_email') ? ' has-error' : '' }}">
                                <label for="m_email" class="col-md-4 control-label">관리자명</label>

                                <div class="col-md-6">
                                    <input id="m_email" type="text" class="form-control" name="m_email"
                                           value="{{ old('m_email') }}" required>
